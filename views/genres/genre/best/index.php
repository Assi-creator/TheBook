...
$genre = $api->getBookByGenreBest($_GET['genre']);
                                ...
                                <div>
                                    ...
                                    <div class="brow-genres">
                                        ...
                                        for ($i = 0; $i < count($genre); $i++):?>
                                            <a class="label-genre" href="/views/genres/genre?genre=<?=$genre[$i]['id_genre']?>"><?=$genre[$i]['name']?></a>
                                        <?php endfor; ?>
                                    </div>
                                    ...
                                    <div class="brow-details">
                                        <table class="compact">
                                            ...
                                            <tr>
                                                ...
                                                <td><span itemprop="isbn"><?=$genreBook['ISBN'] ?></span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><span itemprop="publisher"><p><?=$genreBook['publishing'] ?></p></span>
                                                </td>
                                            </tr>
                                            <tr>
